package com.treemarks.app.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "treemarks@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "treemarks API";

        private String description = "treemarks API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "treemarks";
